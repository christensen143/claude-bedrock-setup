...
class TestEnsureGitignore:
    ...
    def test_ensure_gitignore_empty_file(self, mock_exists, mock_file):
        ...
        write_call = [call for call in mock_file.return_value.write.call_args_list if call[0][0]][-1]
    ...
    def test_ensure_gitignore_pattern_with_trailing_spaces(self, mock_exists, mock_file):
        ...
        # Check that the pattern was added despite similar line with trailing spaces
        write_call = [call for call in mock_file.return_value.write.call_args_list if call[0][0]][-1]
        written_content = write_call[0][0]
