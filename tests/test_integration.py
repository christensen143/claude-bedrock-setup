...
from tests.test_utils import create_temp_settings_file, create_temp_gitignore
...
class TestEndToEndWorkflow:
    ...
    def test_complete_setup_workflow(self, mock_subprocess, mock_auth, mock_gitignore, mock_aws_response):
    ...
    def test_bedrock_api_error_workflow(self, mock_subprocess, mock_auth):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(Exception, match="AccessDeniedException"):
                self.runner.invoke(cli, ['setup', '--non-interactive'], catch_exceptions=False)
...
class TestConcurrencyAndFileSystemEdgeCases:
    ...
    def test_concurrent_gitignore_updates(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Simulate concurrent modification by changing file between read and write
            original_ensure = ensure_gitignore
